...
const timetableData: Record<string, Record<string, { time: string; subject: string }[]>> = {
  "Section F": {
    ...
    Tuesday: [
      { time: "08:10", subject: "Operating Systems (Lab)" },
    ...
    Wednesday: [
      ...
      { time: "09:00", subject: "Mathematics for Computing 3" },
      { time: "09:50", subject: "Operating Systems" },
    ...
    Friday: [
      ...
      { time: "09:50", subject: "Life Skills for Engineers 1" },
      { time: "11:00", subject: "Life Skills for Engineers 1" },
      { time: "11:50", subject: "Data Structures & Algorithms 2" },
      { time: "13:25", subject: "Mathematics for Computing 3 (Lab)" },
      { time: "15:40", subject: "Counselling" },
    ],
  },
  "Section E": {
    Monday: [
    ...
    Tuesday: [
      { time: "08:10", subject: "Introduction to Python" },
      { time: "09:00", subject: "Life Skills for Engineers 1" },
      { time: "09:50", subject: "Life Skills for Engineers 1" },
      { time: "11:00", subject: "Life Skills for Engineers 1" },
      { time: "11:50", subject: "Mathematics for Computing 3" },
    ...
    Friday: [
      ...
      { time: "09:00", subject: "Mathematics for Computing 3" },
      { time: "09:50", subject: "Data Structures & Algorithms 2" },
      { time: "11:00", subject: "Counselling" },
