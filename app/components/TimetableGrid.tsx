...
const timetableData: Record<string, Record<string, { subject: string; time: string; isLab?: boolean }[]>> = {
  "Section F": {
    ...
    Wednesday: [
      ...
      { subject: "Operating Systems", time: "9:00-9:50" },
      { subject: "Mathematics for Computing 3", time: "9:50-10:40" },
    ...
    Friday: [
      ...
      { subject: "Life Skills for Engineers 1", time: "10:50-1:05" },
      { subject: "Data Structures & Algorithms 2", time: "2:00-2:50" },
  ...
  "Section E": {
    ...
    Thursday: [
      { subject: "Fundamentals of AI", time: "8:10-9:00" },
      { subject: "Counselling", time: "9:00-9:50" },
      { subject: "FE I", time: "9:50-10:40" },
